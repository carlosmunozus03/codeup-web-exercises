...
var bill = parseFloat(prompt('How much was you bill?'));
...
var total = bill + tipAmount * 100;

alert("your bill can out to $ " + bill.toFixed(2) + ", you decide to generous " + tipPercentage + "%, witch will result in $ " + (tipAmount * 100) + " to be added to you total is " + total + ".");
/**
 * TODO:
